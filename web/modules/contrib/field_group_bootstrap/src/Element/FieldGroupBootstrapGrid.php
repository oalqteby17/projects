...
class FieldGroupBootstrapGrid extends RenderElement {
  ...
  public function getInfo() {
    ...
    return [
      '#process' => [
        [$class, 'processFieldGroupBootstrapGrid'],
      ],
   ...
   */
  public static function processFieldGroupBootstrapGrid(array &$element, FormStateInterface $form_state, $on_form = TRUE) {
    ...
    if (empty($element['#title'])) {
      $element['#title_label'] = t('Bootstrap Grid');
