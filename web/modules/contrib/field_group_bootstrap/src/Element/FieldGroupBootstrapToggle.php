 ...
 */
class FieldGroupBootstrapToggle extends RenderElement {
  ...
  public function getInfo() {
    ...
    return [
      '#process' => [
        [$class, 'processFieldGroupBootstrapToggle'],
      ],
   ...
   */
  public static function processFieldGroupBootstrapToggle(array &$element, FormStateInterface $form_state, $on_form = TRUE) {
    ...
    if (empty($element['#title'])) {
      $element['#title_label'] = t('Bootstrap Toggle');
